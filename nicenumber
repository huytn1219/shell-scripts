#!/bin/bash
# nicenumber-- Given a number, shows it in comma-seperated form. Expects DD
...
nicenumber()
{
    ...
    # to this script. The decimal separator in the output valus is '.' unless
    ...
    while [ $thousands -gt 999 ]; do
        ...
        # We need 'remaider' to be three digits. Do we need to add zeros?
        while [ ${#remaider} -lt 3 ]; do  # Force leading zeros
            remaider="0$remainder"
        done
